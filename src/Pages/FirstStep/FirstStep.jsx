      ...
      <div className="FirstStep__main-container">
        <div className="FirstStep__main-container-block">
          ...
          <form className="FirstStep__container-form">
            ...
            <label className="FirstStep__label">Select number of owners, employees and contractors</label>
            <select
            ...
            <label className="FirstStep__label">Type of company industry</label>
            <select
              className="FirstStep__form-input"
              name="email"
              type="email"
            ...
            <label className="FirstStep__label">Select avarage monthly revenue before deduction</label>
            <select
              className="FirstStep__form-input"
              name="email"
              placeholder="Select"
